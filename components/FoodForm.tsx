...
const FoodForm: React.FC<{onClose: React.MouseEventHandler<HTMLButtonElement>}> = ({ onClose }) => {
  return (
    <Box mx={5} my={5} >

      <Text color={'brand.main'} fontWeight={'bold'} textAlign={'center'}  >Food Form</Text>
      <FormControl mb={3} >
